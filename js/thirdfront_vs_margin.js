var dataset_3f = [];
		...
		var rect = svg.selectAll("rect")
					  ...
					  .on("mouseover", function(d) {	
											...
											div.html("<font size=3>" + "<b>" + d[6] + "</b>" + "</font>" + "<br/>" + d[2] + "<br/>" + "<br/>" + "Winning Margin " + "&nbsp;" + d[4] + "<br/>" + "Third Front " + "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; " + d[5]).style("left", (mouse[0] + 25) + "px").style("top", (mouse[1] - 28) + "px");	
											if(d[1]<d[8]) {
